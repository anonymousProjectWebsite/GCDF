...
namespace remani_planner
{
    ...
    private:
        ...
        std::vector<Eigen::Vector3d> joint_origin_pos;  // xyz
        std::vector<Eigen::Matrix3d> joint_origin_rot;  // rotation matrix from rpy

        Eigen::Matrix2d B_h_;
        Eigen::Matrix4d T_q_0_;
        int vis_idx_size_;
        Eigen::MatrixXd colli_local_axis;
        ...
        std::string mesh_resource_kinova_base_, mesh_resource_kinova_shoulder_, mesh_resource_kinova_bicep_,
                    mesh_resource_kinova_forearm_, mesh_resource_kinova_wrist1_, mesh_resource_kinova_wrist2_, mesh_resource_kinova_bracelet_;
        ...
        {
            Eigen::Matrix3d R;
            R = Eigen::AngleAxisd(yaw,   Eigen::Vector3d::UnitZ()).toRotationMatrix() *
